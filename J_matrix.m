% function J_matrix=J_matrix(info,P_matrix,control)
function J_matrix=J_matrix(info,P_matrix,control,delta_t_n)
...
%         J_D(2*l,2*l)= d22*(info.V/(5.615*info.delta_t));
        J_D(2*l-1,2*l-1)= d11*(info.V/(5.615*delta_t_n));
        J_D(2*l-1,2*l)= d12*(info.V/(5.615*delta_t_n));
        J_D(2*l,2*l-1)= d21*(info.V/(5.615*delta_t_n));
        J_D(2*l,2*l)= d22*(info.V/(5.615*delta_t_n));
    end
end
