...
for select_L = ["high","mid","low"]
    ...
    for scheme=["ETD2","ETDRK2","ETDRK4-Lie"]%["ETDRK4_TF","ETDRK4_Lie","RK4","ETDRK2","ETD2","RK2","ETD1","Implicit"]
        k=1;
        time_toc_vec=[];
        time_step_vec=[];
        sum_time_vec=[];
...
%             plot(xi,yi,'pr')
        ...
        set(gca,'FontSize', 18)
        hold on
        plot(time_step_vec,trapz_diff_before_kink./trapz_truth_before_kink,'DisplayName',scheme_plot+" "+select_L,'LineWidth',3)
        ...
        set(gca,'FontSize', 18)
        hold on
        plot(time_step_vec,trapz_diff_600./trapz_truth_600,'DisplayName',scheme_plot+" "+select_L,'LineWidth',3)
        ...
        set(gca,'FontSize', 18)
        hold on
        plot(sum_time_vec,trapz_diff_600./trapz_truth_600,'DisplayName',scheme_plot+" "+select_L,'LineWidth',3)
        ...
        set(gca,'FontSize', 18)
        hold on
        plot(time_step_vec,sum_time_vec,'DisplayName',scheme_plot+" "+select_L,'LineWidth',3)
